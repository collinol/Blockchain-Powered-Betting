...
# Create Block
class Block:
    def __init__(self, previousHash, transactionsList, nonce):
        self.magicNumber = 0xD9B4BEF9
        self.transactionCounter = len(transactionsList)

        self.blockHeader = header.Header(previousHash, self.transactionListHashesOnly(transactionsList), nonce)
